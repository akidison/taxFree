...
class CountriesViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return CountriesVC.COUNTRIES_ARRAY.count
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let image = UIImage(named: "\(CountriesVC.COUNTRIES_ARRAY[indexPath.row])")
        cell.imageView?.image = image?.circleMask
        cell.textLabel?.text = CountriesVC.COUNTRIES_ARRAY[indexPath.row]
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        choosedCell = CountriesVC.COUNTRIES_ARRAY[indexPath.row]
